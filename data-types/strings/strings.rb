...
class StringTest < Minitest::Test
  ...
  def test_20
    ...
    # actual_two = greeting.concat(" ", name)
    # expected = "Hello World, my name is Harry Potter"
    #
    # assert_equal expected, actual_two

    # Again, using a different method:
    actual_three = "#{greeting} #{name}"
    expected = "Hello World, my name is Harry Potter"

    assert_equal expected, actual_three

    # # Once more, using a different method:
    # actual_four = greeting.concat(" ", name)
    # expected = "Hello World, my name is Harry Potter"
    #
    # assert_equal expected, actual_four
  end
